 ...
 * @author Admin
 */
public class PemeriksaanPasien extends javax.swing.JDialog {

    /**
     * Creates new form PemeriksaanPasien
     */
    ManagePemeriksaan mp = new ManagePemeriksaan();
    DefaultTableModel tabelModel;
    public PemeriksaanPasien(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PemeriksaanPasien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PemeriksaanPasien dialog = new PemeriksaanPasien(new javax.swing.JFrame(), true);
