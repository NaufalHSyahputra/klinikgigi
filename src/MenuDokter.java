...
public class MenuDokter extends javax.swing.JFrame {
    ...
    public MenuDokter(String data){
        initComponents();
        setIDDokter(data);
    }
    
    public void setIDDokter(String v){
        id_dokter = v;
    }
     ...
     * WARNING: Do NOT mrdify this code. The content of this method is always
